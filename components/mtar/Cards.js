...
const Cards = () => {
  return (
    <div>
      {/* <BeltBlue text="Massive Learning in MTAP(2.0)" /> */}
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-600 bg-opacity-40 p-6 rounded-lg">
                <img
                  class="h-50 rounded w-full object-cover object-center mb-3"
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <div class="bg-gray-600 bg-opacity-40 p-6 rounded-lg">
                <img
                  class="h-50 rounded w-full object-cover object-center mb-10"
